...
单体组件风险升序专项拆分,**完工线:operate.tsx < 1500 行只管编排+布局**。T1-T18(批次一~五)已全部完工 2026-09-03,operate.tsx 10,037→2,117 行,棘轮 430→332,174 tests;完工线 <1,500 未达(余量为 state 装配+props 透传+注释历史块+死代码,收敛方案记 plan.md 待后续立项),计划与逐块 tickets 见 `docs/operate-split/`。
